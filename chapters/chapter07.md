...
エンジニアリングマネージャーとは、こういった課題に向き合わなければなりません。
なぜか？彼らから見ればエンジニアも同じ様に見えているからです。

- 「またエンジニアが顧客の要望に寄り添ってくれない...」
- 「いまは技術負債よりも機能開発で競合に勝たなければならない...」
- 「エンジニアには無理を言うが、仕様は作りながら、顧客の反応を見ながら決めたい...」

エンジニアリングマネージャーのの仕事の多くは「翻訳」にあります。
技術の言葉をビジネスの言葉に、ビジネスの要求を技術のタスクに。この翻訳をすることで会社の機能としてのエンジニアチームは円滑に周り出します。

更には、エンジニアリングマネージャーだけ自身でなく、エンジニアチーム全体が多職種とのコミュニケーションを円滑にすることは、組織全体のスピードと品質を高めるうえで非常に重要です。
...
この章では「技術以外の人たち」とのコミュニケーションについて記載します。
